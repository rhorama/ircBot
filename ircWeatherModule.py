...
def main(switchInput, f):
    ...
    currentWeatherUrl = "http://api.openweathermap.org/data/2.5/weather?q=" + switchInput.strip(' ') + "&units=imperial" + apikey
    ...
    out = [mainCondition, conditionDesc, temp, feelsLike, pressure, humidity, city, country, wind, coord]


    oneCallWeatherUrl = "https://api.openweathermap.org/data/2.5/onecall?lat=" + str(lat) + "&lon=" + str(lon) + "&exclude=minutely,hourly" + "&units=imperial" + apikey
